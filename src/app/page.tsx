                  ...
                  <div className="mt-auto flex flex-wrap items-center gap-2">
                    ...
                    {project.repo && (
                      <a
                        ...
                        className="ml-auto flex items-center gap-1.5 rounded-full border border-line px-3 py-1 font-mono text-[10.5px] tracking-[0.06em] text-ink-muted transition-colors hover:border-cyan hover:text-cyan"
                      >
                        <svg
                          width="12"
                          height="12"
