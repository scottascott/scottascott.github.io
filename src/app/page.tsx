        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-7">
          {sideProjects.map((project) => (
            <Reveal key={project.name} className="h-full">
              <div className="group flex h-full flex-col overflow-hidden rounded border border-line bg-panel/50 backdrop-blur-lg transition-all duration-300 hover:-translate-y-1 hover:border-line-strong">
                <PopupLink
                  href={project.url}
                  popup={project.popup}
                  className="block"
                ...
                <div className="flex flex-1 flex-col px-6 pt-6 pb-7">
                  ...
                  >
                    <h3 className="mb-2.5 font-serif text-2xl text-ink transition-colors hover:text-cyan">
                      {project.name}
                    </h3>
                  </PopupLink>
                  ...
                  <div className="mt-auto flex flex-wrap items-center gap-2">
                    ...
                    {project.repo && (
                      <a
                        ...
                        className="group/repo ml-auto flex items-center gap-1.5 py-1 font-mono text-[10.5px] tracking-[0.06em] text-ink-muted transition-colors duration-200 hover:text-cyan"
                      >
                        <svg
                          width="13"
                          height="13"
                          ...
                          fill="currentColor"
                          aria-hidden="true"
                          className="transition-transform duration-200 group-hover/repo:-translate-y-px"
                        >
                        ...
                        <svg
                          ...
                          fill="none"
                          aria-hidden="true"
                          className="opacity-45 transition-all duration-200 group-hover/repo:translate-x-0.5 group-hover/repo:-translate-y-0.5 group-hover/repo:opacity-100"
                        >
                          <path
                            d="M3 9L9 3M5 3H9V7"
                            stroke="currentColor"
